...
public class TMemberDTO {
    ...
    private String m__first_name_kana;
    private String m__last_name_kana;
	...
	public String getM__first_name_kana() {
		return m__first_name_kana;
	}
	public void setM__first_name_kana(String m__first_name_kana) {
		this.m__first_name_kana = m__first_name_kana;
	}
	public String getM__last_name_kana() {
		return m__last_name_kana;
	}
	public void setM__last_name_kana(String m__last_name_kana) {
		this.m__last_name_kana = m__last_name_kana;
	}
	...
	public String toString() {
		return "TMemberDTO [m_id=" + m_id + ", m_pw=" + m_pw + ", m_first_name=" + m_first_name + ", m_last_name="
				+ m_last_name + ", m__first_name_kana=" + m__first_name_kana + ", m__last_name_kana="
				+ m__last_name_kana + ", m_first_name_rome=" + m_first_name_rome + ", m_last_name_rome="
				+ m_last_name_rome + ", m_birth=" + m_birth + ", m_gender=" + m_gender + ", m_email=" + m_email
				+ ", m_regdate=" + m_regdate + ", m_img=" + m_img + ", m_phone=" + m_phone + ", a_address=" + a_address
				+ ", a_postcode=" + a_postcode + "]";
	}
	public TMemberDTO(String m_id, String m_pw, String m_first_name, String m_last_name, String m__first_name_kana,
			String m__last_name_kana, String m_first_name_rome, String m_last_name_rome, String m_birth,
