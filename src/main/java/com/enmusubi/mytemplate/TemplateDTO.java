...
public class TemplateDTO {
	...
	public TemplateDTO(int e_no, String w_groom, String w_bride, String w_img, int r_no, String t_preview,
			String r_time, int t_pk) {
		super();
		this.e_no = e_no;
	...
	public String toString() {
		return "TemplateDTO [e_no=" + e_no + ", w_groom=" + w_groom + ", w_bride=" + w_bride + ", w_img=" + w_img
				+ ", r_no=" + r_no + ", t_preview=" + t_preview + ", r_time=" + r_time + ", t_pk=" + t_pk + "]";
	}
}
