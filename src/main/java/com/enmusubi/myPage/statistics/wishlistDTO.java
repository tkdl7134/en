...
public class wishlistDTO {
	...
	public wishlistDTO(int w_no, String w_product, int w_price, int e_no, String w_comment, int total_price,
			Date w_date) {
		super();
		this.w_no = w_no;
	...
	public String toString() {
		return "wishlistDTO [w_no=" + w_no + ", w_product=" + w_product + ", w_price=" + w_price + ", e_no=" + e_no
				+ ", w_comment=" + w_comment + ", total_price=" + total_price + ", w_date=" + w_date + "]";
	}
