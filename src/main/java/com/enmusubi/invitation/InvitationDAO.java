...
public class InvitationDAO {
    ...
    public static void invitations(HttpServletRequest request) {
        ...
        String sql = "SELECT sg.e_no, swi.w_groom, swi.w_bride, swi.w_img, " +
                     "sm.m_id, sm.m_name, sm.m_phone, sm.m_email, " +
                     "sg.g_attend, sg.g_guest_type, sg.g_message, sg.g_relation, " +
                     "sa2.allergy, " +
                     "sp.p_adult, sp.p_child, sp.p_baby " +
                     "FROM S_GUEST sg " +
                     ...
                     "LEFT OUTER JOIN S_PARTY sp ON sg.M_ID = sp.M_ID " +
        ...
        try {
            ...
            while (rs.next()) {
                ...
                i = new InvitationDTO(e_no, w_groom, w_bride, w_img, m_id, m_name, m_phone, m_email, g_attend, g_guest_type, 
                                      g_message, g_relation, allergy, p_adult, p_child, p_baby);
