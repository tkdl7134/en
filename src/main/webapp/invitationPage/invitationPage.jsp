...
<body id="page_top">
	<form action="InvitationController" method="post">
		<div class="hw_up_img"></div>
		<div class="hw_container">
			<header class="hw_invitation_header">
				<a class="hw_logo" href="main.jsp"><img src="invitationPage/imgFolder/logo.png"
					alt="logo" ></a>
				<a class="hw_pagetitle" href="main.jsp"><img src="invitationPage/imgFolder/pagetitle.png"
					alt="pagetitle" ></a>
								...
								<c:forEach var="invitation" items="${invitationsYes}">
									<div class="hw_invitation_content">
										<span class="hw_invitation_small">${invitation.m_name}</span> <span
											class="hw_invitation_small">${invitation.g_guest_type}</span>
					...
					<div class="hw_detail_wrapper" style="display: none;">
						<div class="styled-table-wrapper">
							...
							<c:forEach var="invitation" items="${invitationsYes}" varStatus="status">
								<div class="hw_invitation_content">
									<span class="hw_invitation_small">${invitation.m_name}</span> <span
										class="hw_invitation_middie">大人: ${invitation.p_adult} 子供: ${invitation.p_child} 幼児: ${invitation.p_baby}</span> <span
						...
						<div class="styled-table-wrapper">
							<div class="hw_invitation_title">
								...
								<c:forEach var="invitation" items="${invitationsNo}">
									<div class="hw_invitation_content">
										<span class="hw_invitation_small">${invitation.m_name}</span> <span
											class="hw_invitation_small">${invitation.g_guest_type}</span> <span
											class="hw_invitation_middie">${invitation.m_phone}</span> <span
											class="hw_invitation_big">${invitation.m_email}</span>
									</div>
								</c:forEach>
							</div>
						</div>
