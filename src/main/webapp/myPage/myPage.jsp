				...
				<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
						...
						<c:if test="${not empty dto}">
							...
							<div class="hs_background">
								...
								<div class="yj-main-s2-logo">
									<img class="yj-main-s2-logo img" alt="" src="loginPage/ImgFolder/Logo.png">
								</div>
								<div class="yj-main-s2-menu">
									<img class="yj-main-s2-menu img" alt="" src="loginPage/ImgFolder/default_menu_1.png">
								</div>
								<div class="hs_title">会員情報</div>

								<div class="hs_mypage-menus">
									<div class="hs_btn-container">
										<a href="MemberDetailC" class="hs_btn me">✿ 会員情報 ✿</a> <img class="yellow_line" alt=""
											src="loginPage/ImgFolder/yellow_line.png">
									</div>
									<div class="hs_btn-container">
										<a href="#" class="hs_btn ">✿ テンプレート管理 ✿</a> <img class="yellow_line" alt=""
											src="loginPage/ImgFolder/yellow_line.png">
									</div>
									<!-- <div class="hs_btn-container">
					<a href="#" class="hs_btn ">✿ 心からのお伝え ✿</a> <img
						...
						src="loginPage/ImgFolder/yellow_line.png">
									...
									<div class="hs_btn-container">
										<a href="#" class="hs_btn ">✿ 会リスト ✿</a> <img class="yellow_line" alt=""
											src="loginPage/ImgFolder/yellow_line.png">
									</div>
								</div>
									...
									<div class="hs_container-input">
										...
										<div class="btn-box">
											...
											<form id="deleteForm" action="MemberDeleteC" method="post">
												<button type="button" onclick="confirmDelete()" class="btn delete">アカウント削除</button>
											</form>
										</div>
									</div>
								</div>
