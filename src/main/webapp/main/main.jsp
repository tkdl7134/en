...
<body>
	...
	<div class="yj-main-section" id="yj-main-s3">
		...
		<div class="yj-main-logo">
			<a href="#" class="mainLogo"><img
				src="main/imgFolder/yj-main-logo.png" alt="섹션3 로고" /></a>
		</div>
	...
	<div class="yj-main-section" id="yj-main-s4">
		...
		<div class="yj-main-logo">
			<a href="#" class="mainLogo"><img
				src="main/imgFolder/yj-main-logo.png" alt="섹션4 로고" /></a>
		</div>
	...
	<div class="yj-main-section" id="yj-main-s5">
		...
		<div class="yj-main-logo">
			<a href="#" class="mainLogo"><img
				src="main/imgFolder/yj-main-logo.png" alt="섹션5 로고" /></a>
		</div>
		...
		<div class="yj-main-s5-bigCon">
			<div class="yj-main-s5-container">
				<img class="yj-main-s5-invitation"
					src="main/imgFolder/yj-main-s5-invitation.png" alt="" />
			</div>
		</div>
	</div>
	...
	<div class="yj-main-section" id="yj-main-s6">
		...
		<div class="yj-main-logo">
			<a href="#" class="mainLogo"><img
				src="main/imgFolder/yj-main-logo.png" alt="섹션6 로고" /></a>
		</div>
