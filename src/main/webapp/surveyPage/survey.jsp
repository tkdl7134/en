		...
		<header class="tk_survey_header">
			...
			<div class="middle-title">
				...
				<div class="middle-img">
					<img src="imgFolder/footer.png" alt="title"
						style="width: 100%; height: 100%" />
				</div>
			</div>
		...
		<main class="tk_survey_main">
			<div class="main-content">
				<div class="main-content-words">
					...
					<div>
						<img src="imgFolder/arrowline.png" alt="menu-button"
							style="width: 100%; height: 100%" />
					</div>
				</div>
						...
						<div class="survey-input">
							...
							<div>
								<div class="tg-slide-page">
									<div class="">
										<div>ゲストカテゴリー</div>
										<label> <input name="interest" type="checkbox"
											value="groom" /> 新郎側ゲスト
										</label> <label> <input name="interest" type="checkbox"
											value="bride" /> 新婦側ゲスト
										</label>
									</div>
									...
									<div class="together-container">
										...
										<input style="width: 2rem" class="result" value="0" id="adult" />
										<input type="button" onclick='count("minus","adult")'
											value="-" />
										<div class="together-people">子供</div>
										<input type="button" onclick='count("plus","child")' value="+" />
										<input style="width: 2rem" class="result" value="0" id="child" />
										<input type="button" onclick='count("minus","child")'
											value="-" />
										<div class="together-people">幼児</div>
										<input type="button" onclick='count("plus","baby")' value="+" />
										<input style="width: 2rem" class="result baby" value="0"
											id="baby" /> <input type="button"
											onclick='count("minus","baby")' value="-" />
									</div>
									<div class="name-container">
										<fieldset>
											...
											<label class="kanzi-container">
												<div style="font-size: 1.2rem;">漢字</div> <input type="text"
												placeholder="姓" class="name-input" required /> <input
												type="text" placeholder="名" class="name-input" required />
											</label></br> <label class="kata-container">
												<div style="font-size: 1.2rem;">カタカナ</div> <input
												type="text" placeholder="せい" class="name-input" required />
												<input type="text" placeholder="めい" class="name-input"
												required />
											</label></br> <label class="eng-container">
												<div style="font-size: 1.2rem;">ローマ字</div> <input
												type="text" placeholder="Last Name" class="name-input"
												required /> <input type="text" placeholder="First Name"
									...
									<div class="contact-container">
										<div>
											メールアドレス<input type="email" class="contact-input" name="email"
												required />
										</div>
										<div>
											電話番号 <input type="number" class="contact-input"
								...
								<div class="address-container">
									<fieldset>
										<legend>
											...
											&nbsp&nbsp&nbsp
											<div style="font-size: 1.5rem;">住所入力フォーム</div>
										</legend>
										<div class="address-contents-contaoner">
											...
											<div class="address-contents-contaoner">
												...
												<div>
													<input type="text" id="city" name="city" placeholder="新宿区"
														required />
												</div>
											</div>
